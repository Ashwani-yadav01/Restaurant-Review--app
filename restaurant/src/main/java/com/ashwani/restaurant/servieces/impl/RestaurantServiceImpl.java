package com.ashwani.restaurant.servieces.impl;
...
import com.ashwani.restaurant.repositories.RestaurantRepository;
import com.ashwani.restaurant.servieces.GeoLocationService;
...
public class RestaurantServiceImpl implements RestaurantService {
    ...
    public Page<Restaurant> searchRestaurants(String query, Float minRating, Float latitude,
        ...
        if (minRating != null && (null == query || query.isEmpty())) {
    ...
    public Restaurant updateRestaurant(String id, RestaurantCreateUpdateRequest request) {
        ...
        Restaurant restaurant = getRestaurant(id)
                .orElseThrow(() -> new RestaurantNotFoundException("Restaurant with ID does not exits: " + id));
