...
import com.ashwani.restaurant.domain.dtos.RestaurantSummaryDto;
...
public class RestaurantController {
    ...
    public ResponseEntity<RestaurantDto> updateRestaurant(
        ...
        Restaurant updatedRestaurantrestaurant = restaurantService.updateRestaurant(restaurantId, request);
        return ResponseEntity.ok(restaurantMapper.toRestaurantDto(updatedRestaurantrestaurant));
    }
